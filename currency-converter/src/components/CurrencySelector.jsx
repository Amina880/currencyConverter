...
function CurrencySelector() {
  ...
  return (
    ...
    <form onSubmit={onConvert} className='w-11/12 sm:w-8/12 mx-auto justify-center bg-white dark:bg-slate-800 rounded-2xl px-6 pt-4 flex-grow mt-4 pb-5 sm:flex-grow-0 '>
        ...
        <div className=' mt-6 sm:flex sm:justify-evenly sm:mx-auto sm:items-center sm:w-full sm:mt-3'>
            ...
            <div className='sm:flex sm:flex-col sm:h-[70px] sm:w-2/6 sm:mx-1'>
                <label htmlFor='amount' className='mt-4 sm:m-0 sm:text-lg font-normal dark:text-slate-200'>Amount:</label>
                <input
                id='amount'
            ...
            <div className='my-4 w-full mx-auto sm:mx-1 sm:w-2/6 '>
                <label className='sm:text-lg font-normal dark:text-slate-200'>From:</label>
                <Select
            ...
            <div className='my-4 w-full sm:w-2/6 mx-auto sm:mx-1'>
                <label className='sm:text-lg font-normal dark:text-slate-200' >To:</label>
                <Select 
                className='font-shippori text-lg'
                options={currencyOptions}
        ...
        <button className='my-4 items-center mx-auto w-full sm:w-44 sm:h-10 sm:my-2 sm:float-end p-2 hover:border-blue-300 dark:hover:border-blue-400 bg-sky-500 dark:bg-sky-600 hover:border-2 rounded-xl text-white' type='submit'>Convert</button>
    </form>
    </>
  )
}
